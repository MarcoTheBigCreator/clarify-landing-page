...
export const values = [
  {
    icon: <HeartIcon className="h-12 w-12 mb-4" />,
    title: 'Empatía',
    description:
  ...
  {
    icon: <CheckCircledIcon className="h-12 w-12 mb-4" />,
